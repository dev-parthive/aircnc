...
const CommingSoon = () => {
    return (
        <div className='flex justify-center items-center mt-[300px]'>
            ...
            <div className='w-9 h-9 border-8 border-d border-dashed
             rounded-full animate-spin mt-3 border-green-400 '>
                </div>
                ...
                <div className='w-9 h-9 border-8 border-dashed rounded-full animate-spin mt-3 border-green-400 ml-2'></div>
