        ...
        <div className='flex-1 max-w-lg'>
            <div className='flex justify-between'>
                <div>
                    ...
                    <br />
                    <h3 className='text-gray-400 text-xl tracking-widest title-font mb-1 mt-1'>{homeData?.location}</h3>
                    <h3 className='text-gray-400 text-xs tracking-widest title-font mb-1 mt-1'>
                        {homeData.total_guest} Guest {homeData.bedroom} Bedrooms {' '} {homeData.bathrooms} bathrooms.
                    </h3>
                </div>

                <div>
                    <div className='flex flex-col items-center'>
                        <img src={homeData?.host?.image} alt=""
                            className='w-16 h-16 border rounded-full' referrerPolicy='no-referrer'
                        />
            ...
            <hr />
            <div>
                <div className='flex flex-col items-start pb-4 my-2 mt-8 mx-auto max-w-7xl '>
                    <div className='inline-flex items-center justify-center flex-shrink-0 w-5 h-5 mt-1 text-neutral-600 rounded-full bg-gray sm:mr-3'>
                        <HomeIcon></HomeIcon>
                    </div>

                    <div>
                        <p className='flex-grow prose sm:text-left prose-md'>Entire Home</p>
