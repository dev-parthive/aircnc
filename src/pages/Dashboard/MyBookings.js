...
import { getAllBookingsByEmail } from '../../api/bookingsApi';
import SmallSpinner from '../../Shared/Spinner/SmallSpinner';
import SmallLoadingSpinner from '../../Shared/Spinner/SmallLoadingSpinner';
import Sspinner from '../../Shared/Spinner/Sspinner';
            ...
            <div className='-mx-4 sm:-mx-8 px-4 sm:px-8 py-4 overflow-x-auto'>
              <div className='inline-block min-w-full shadow rounded-lg overflow-hidden'>
                <table className='min-w-full leading-normal'>
                  ...
                  <tbody>
                    { loading ? <Sspinner></Sspinner>: <>{ bookings &&  bookings.map((booking, i) => <tr key={ i + 1}>
